...
- [ ] **Step 1: 신규 글 작성 지침과 URL 충돌 여부를 확인한다**
...
- [ ] **Step 2: 원문의 삭제 권고를 공식 이행 문서와 대조한다**
...
- [ ] **Step 3: 범위를 ‘지시 삭제’가 아닌 ‘하네스 규칙 감사’로 고정한다**
...
- [ ] **Step 5: 초안을 정적 검사하고 로컬 렌더링을 확인한다**
...
- [ ] **Step 6: 사용자 검토를 위해 초안을 인계하고 중단한다**
